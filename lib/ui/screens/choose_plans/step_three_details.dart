...
class StepThreeDetails extends StatefulWidget {
  Map map;
  StepThreeDetails({super.key,required this.map});

  @override
  State<StepThreeDetails> createState() => _StepThreeDetailsState();
}

class _StepThreeDetailsState extends State<StepThreeDetails> {
