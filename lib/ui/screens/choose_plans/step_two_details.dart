  ...
  _createUser() async{
    ...
    if(!isLoading){
      if(emailController.text.isEmpty){
        ...
        await Provider.of<AccountCreateController>(context, listen: false).postCreateAccount(emailController.text.trim().toString(),passwordController.text.toString());
        if(Provider.of<AccountCreateController>(context, listen: false).account.status == Status.COMPLETED){
          Helper.email = emailController.text.trim().toString();
          Helper.password = passwordController.text.toString();
