...
class StepThreeInfo extends StatefulWidget {
  Map map;
  StepThreeInfo({super.key,required this.map});

  @override
  State<StepThreeInfo> createState() => _StepThreeInfoState();
}

class _StepThreeInfoState extends State<StepThreeInfo> {
