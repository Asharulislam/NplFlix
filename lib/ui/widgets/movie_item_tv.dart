...
class MovieItemTv extends StatelessWidget {
  var id;
  var title;
  var year;
  var details;
  var duration;
  MovieItemTv({super.key,required this.id,required this.title,required this.year, required this.details,required this.duration});
